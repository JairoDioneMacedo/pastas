 ...
 * @author Jairo
 */
public class PastaCRUD2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acao.equals("alterar")) {
            ...
            rd = request.getRequestDispatcher("PastaCRUD2?acao=listaPastas");
            ...
            try {
                ...
                rd = request.getRequestDispatcher("/listapastasolicitadas1.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PastaCRUD2.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(PastaCRUD2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
